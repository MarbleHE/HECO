#ifndef AST_OPTIMIZER_INCLUDE_UTILITIES_RANDNUMGEN_H_
#define AST_OPTIMIZER_INCLUDE_UTILITIES_RANDNUMGEN_H_
...
#endif //AST_OPTIMIZER_INCLUDE_UTILITIES_RANDNUMGEN_H_
