...
#include "heco/ast_utilities/warning_hidingNonVirtualFunction_prologue.h"
...
{
  return (dynamic_cast<LiteralBool *>(&node) != nullptr) || (dynamic_cast<LiteralChar *>(&node) != nullptr) || (dynamic_cast<LiteralInt *>(&node) != nullptr) || (dynamic_cast<LiteralFloat *>(&node) != nullptr) || (dynamic_cast<LiteralDouble *>(&node) != nullptr) || (dynamic_cast<LiteralString *>(&node) != nullptr);
}
