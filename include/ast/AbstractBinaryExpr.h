#ifndef AST_OPTIMIZER_INCLUDE_AST_ABSTRACTBINARYEXPR_H_
#define AST_OPTIMIZER_INCLUDE_AST_ABSTRACTBINARYEXPR_H_
...
#endif //AST_OPTIMIZER_INCLUDE_AST_ABSTRACTBINARYEXPR_H_
