#ifndef AST_OPTIMIZER_INCLUDE_AST_OPT_VISITOR_MULTDEPTHVISITOR_H_
#define AST_OPTIMIZER_INCLUDE_AST_OPT_VISITOR_MULTDEPTHVISITOR_H_
...
#endif //AST_OPTIMIZER_INCLUDE_AST_OPT_VISITOR_MULTDEPTHVISITOR_H_
