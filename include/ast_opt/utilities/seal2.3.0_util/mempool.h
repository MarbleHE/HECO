...
namespace seal_util
{
        ...
        public:
            ...
            {
                std::uint64_t uint64_count = (byte_count + seal::util::bytes_per_uint64 - 1) / seal::util::bytes_per_uint64;
            ...
            {
                seal::util::ReaderLock lock = pools_locker_.acquire_read();
                return pools_.size();
            }
            ...
            {
                return alloc_uint64_count() * seal::util::bytes_per_uint64;
            }
        ...
        private:
            ...
            mutable seal::util::ReaderWriterLocker pools_locker_;
        ...
        inline Pointer duplicate_if_needed(std::uint64_t *original, int uint64_count, bool condition, MemoryPool &pool)
        {
            ...
            std::memcpy(allocation.get(), original, uint64_count * seal::util::bytes_per_uint64);
            return allocation;
        }
