...
inline void modulo_uint(const std::uint64_t *value,
                        int value_uint64_count,
...
inline void multiply_uint_uint_mod(const std::uint64_t *operand1,
                                   const std::uint64_t *operand2,
                                   const Modulus &modulus,
                                   std::uint64_t *result,
                                   MemoryPool &pool) {
...
inline void multiply_uint_uint_mod_inplace(const std::uint64_t *operand1,
                                           const std::uint64_t *operand2,
                                           const Modulus &modulus,
                                           std::uint64_t *result,
                                           MemoryPool &pool) {
...
void exponentiate_uint_mod(const std::uint64_t *operand, const std::uint64_t *exponent, int exponent_uint64_count,
                           const seal_old::util::Modulus &modulus, std::uint64_t *result, MemoryPool &pool);
}
}