...
std::string uint_to_dec_string(const std::uint64_t *value, int uint64_count, seal::util::MemoryPool &pool);
...
inline ConstPointer duplicate_uint_if_needed(const std::uint64_t *uint,
                                             int uint64_count,
                                             int new_uint64_count,
                                             bool force,
                                             MemoryPool &pool) {
#ifdef SEAL_DEBUG
