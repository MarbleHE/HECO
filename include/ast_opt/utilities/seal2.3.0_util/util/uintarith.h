...
inline unsigned char add_uint64_generic(std::uint64_t operand1,
...
inline unsigned char add_uint64(std::uint64_t operand1,
                                std::uint64_t operand2,
                                unsigned char carry,
                                std::uint64_t *result) {
...
inline unsigned char add_uint_uint(const std::uint64_t *operand1,
                                   int operand1_uint64_count,
                                   const std::uint64_t *operand2,
                                   int operand2_uint64_count,
                                   unsigned char carry,
...
inline unsigned char sub_uint64_generic(std::uint64_t operand1,
                                        std::uint64_t operand2,
...
#pragma managed(push, off)
inline unsigned char sub_uint64(std::uint64_t operand1,
                                std::uint64_t operand2,
                                unsigned char borrow,
                                std::uint64_t *result) {
...
#endif
  int uint64_shift_amount = shift_amount/seal::util::bits_per_uint64;
  int bit_shift_amount = shift_amount - uint64_shift_amount*seal::util::bits_per_uint64;
  int neg_bit_shift_amount =
      (seal::util::bits_per_uint64 - bit_shift_amount) & (static_cast<std::uint64_t>(bit_shift_amount==0) - 1);
...
inline void right_shift_uint(const std::uint64_t *operand, int shift_amount, int uint64_count, std::uint64_t *result) {
  ...
  int bit_shift_amount = shift_amount - uint64_shift_amount*seal::util::bits_per_uint64;
  int neg_bit_shift_amount =
      (seal::util::bits_per_uint64 - bit_shift_amount) & (static_cast<int32_t>(bit_shift_amount==0) - 1);
...
inline void half_round_up_uint(const std::uint64_t *operand, int uint64_count, std::uint64_t *result) {
  ...
  for (int i = 0; i < uint64_count - 1; i++) {
    result[i] = (operand[i] >> 1) | (operand[i + 1] << (seal::util::bits_per_uint64 - 1));
  }
