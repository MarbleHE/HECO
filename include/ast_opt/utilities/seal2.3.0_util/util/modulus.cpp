...
Modulus::Modulus(Modulus &&source) noexcept: modulus_(source.modulus_),
                                             uint64_count_(source.uint64_count_),
                                             significant_bit_count_(source.significant_bit_count_),
                                             power_of_two_minus_one_(source.power_of_two_minus_one_),
                                             inverse_significant_bit_count_(source.inverse_significant_bit_count_),
                                             inverse_modulus_(move(source.inverse_modulus_)) {
