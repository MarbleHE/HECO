...
namespace seal_util
{
    ...
    */
    ...
    public:
        ...
        */
        inline static MemoryPoolHandle Global()
        {
            ...
            return MemoryPoolHandle(std::shared_ptr<seal_util::MemoryPool>(std::shared_ptr<seal_util::MemoryPool>(),
        ...
        */
        inline static MemoryPoolHandle New(bool thread_safe = true)
        {
            if (thread_safe)
            {
                return MemoryPoolHandle(std::make_shared<seal_util::MemoryPoolMT>());
            }
            return MemoryPoolHandle(std::make_shared<seal_util::MemoryPoolST>());
        }
        ...
        */
        inline operator seal_util::MemoryPool &() const
        {
#ifdef SEAL_DEBUG
            if (!pool_)
            {
    ...
    private:
        MemoryPoolHandle(std::shared_ptr<seal_util::MemoryPool> pool) noexcept :
            pool_(std::move(pool))
        {
        }

        std::shared_ptr<seal_util::MemoryPool> pool_ = nullptr;
    };
}