...
class MemoryPoolHandle {
  ...
  */
  inline static MemoryPoolHandle Global() {
    ...
    return MemoryPoolHandle(std::shared_ptr<seal_old::util::MemoryPool>(std::shared_ptr<seal_old::util::MemoryPool>(),
                                                                        seal::util::global_variables::global_memory_pool));
  }
  ...
  */
  inline static MemoryPoolHandle New(bool thread_safe = true) {
    if (thread_safe) {
      return MemoryPoolHandle(std::make_shared<seal_old::util::MemoryPoolMT>());
    }
    return MemoryPoolHandle(std::make_shared<seal_old::util::MemoryPoolST>());
  }
  ...
  */
  inline operator seal_old::util::MemoryPool &() const {
#ifdef SEAL_DEBUG
    if (!pool_)
    {
 ...
 private:
  MemoryPoolHandle(std::shared_ptr<seal_old::util::MemoryPool> pool) noexcept:
      pool_(std::move(pool)) {
  }

  std::shared_ptr<seal_old::util::MemoryPool> pool_ = nullptr;
};
}