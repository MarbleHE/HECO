...
#include "ast_opt/utilities/seal2.3.0_util/util/mempool.h"
#include "ast_opt/utilities/seal2.3.0_util/util/common.h"
#include "ast_opt/utilities/seal2.3.0_util/util/uintcore.h"
#include "ast_opt/utilities/seal2.3.0_util/util/uintarith.h"
#include "ast_opt/utilities/seal2.3.0_util/util/uintarithmod.h"
...
value from a concurrent write. A non-aliased BigUInt allocates its backing array from the global (thread-safe)
memory pool. Consequently, creating or resizing a large number of BigUInt can result in a performance loss due
to thread contention.
*/
class BigUInt {
 public:
  /**
  ...
  */
  inline int byte_count() const {
    return seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_byte);
  }
  ...
  */
  inline int uint64_count() const {
    return seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
  }
  ...
  */
  inline int significant_bit_count() const {
    ...
    int uint64_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
    return seal_old::util::get_significant_bit_count_uint(value_.get(), uint64_count);
  }
  ...
  */
  inline bool is_zero() const {
    ...
    int uint64_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
    return seal_old::util::is_zero_uint(value_.get(), uint64_count);
  }
  ...
  */
  inline std::uint8_t operator[](int index) const {
    int byte_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_byte);
    if (index < 0 || index >= byte_count) {
      throw std::out_of_range("index must be within [0, byte count)");
    }
    return *seal_old::util::get_uint64_byte(value_.get(), index);
  }
  ...
  */
  inline void set_zero() {
    if (bit_count_ > 0) {
      int uint64_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
      return seal_old::util::set_zero_uint(uint64_count, value_.get());
    }
  }
  ...
  */
  inline void alias(int bit_count, std::uint64_t *value) {
    ...
    // Update class.
    value_ = seal_old::util::Pointer::Aliasing(value);
  ...
  */
  inline BigUInt &operator=(std::uint64_t value) {
    int assign_bit_count = seal_old::util::get_significant_bit_count(value);
    ...
    if (bit_count_ > 0) {
      int uint64_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
      seal_old::util::set_uint(value, uint64_count, value_.get());
    }
    return *this;
  }
  ...
  */
  inline BigUInt operator-() const {
    ...
    seal_old::util::negate_uint(value_.get(), result.uint64_count(), result.pointer());
    seal_old::util::filter_highbits_uint(result.pointer(), result.uint64_count(), result.bit_count());
    return result;
  }
  ...
  */
  inline BigUInt operator~() const {
    BigUInt result(bit_count_);
    seal_old::util::not_uint(value_.get(), result.uint64_count(), result.pointer());
    seal_old::util::filter_highbits_uint(result.pointer(), result.uint64_count(), result.bit_count());
    return result;
  }
  ...
  */
  inline BigUInt &operator++() {
    if (seal_old::util::increment_uint(value_.get(), uint64_count(), value_.get())) {
      int carry_bit = bit_count_;
      resize(bit_count_ + 1);
      seal_old::util::set_bit_uint(value_.get(), uint64_count(), carry_bit);
    }
  ...
  */
  inline BigUInt &operator--() {
    seal_old::util::decrement_uint(value_.get(), uint64_count(), value_.get());
    seal_old::util::filter_highbits_uint(value_.get(), uint64_count(), bit_count_);
    return *this;
  }
  ...
  */
  inline BigUInt operator++(int postfix) {
    BigUInt result;
    result = *this;
    if (seal_old::util::increment_uint(value_.get(), uint64_count(), value_.get())) {
      int carry_bit = bit_count_;
  ...
  */
  inline BigUInt operator+(const BigUInt &operand2) const {
    int result_bits = std::max(significant_bit_count(), operand2.significant_bit_count()) + 1;
    BigUInt result(result_bits);
    seal_old::util::add_uint_uint(value_.get(),
                                  uint64_count(),
                                  operand2.pointer(),
  ...
  */
  inline BigUInt operator-(const BigUInt &operand2) const {
    ...
    BigUInt result(result_bits);
    seal_old::util::sub_uint_uint(value_.get(),
                                  uint64_count(),
                                  operand2.pointer(),
                                  operand2.uint64_count(),
                                  false,
                                  result.uint64_count(),
                                  result.pointer());
    seal_old::util::filter_highbits_uint(result.pointer(), result.uint64_count(), result_bits);
    return result;
  }
  ...
  */
  inline BigUInt operator*(const BigUInt &operand2) const {
    ...
    BigUInt result(result_bits);
    seal_old::util::multiply_uint_uint(value_.get(),
                                       uint64_count(),
                                       operand2.pointer(),
                                       operand2.uint64_count(),
                                       result.uint64_count(),
  ...
  */
  inline BigUInt operator%(const BigUInt &operand2) const {
    ...
    seal_old::util::Modulus modulus(operand2.pointer(), operand2.uint64_count(), pool_);
    int result_bits = significant_bit_count();
    BigUInt result(result_bits);
    result = *this;
    int uint64_count = seal_old::util::divide_round_up(result_bits, seal_old::util::bits_per_uint64);
  ...
  */
  inline BigUInt operator^(const BigUInt &operand2) const {
    ...
    if (uint64_count!=this->uint64_count()) {
      result = *this;
      seal_old::util::xor_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
    } else if (uint64_count!=operand2.uint64_count()) {
      result = operand2;
      seal_old::util::xor_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
    } else {
      seal_old::util::xor_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
    }
    return result;
  }
  ...
  */
  inline BigUInt operator&(const BigUInt &operand2) const {
    ...
    if (uint64_count!=this->uint64_count()) {
      result = *this;
      seal_old::util::and_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
    } else if (uint64_count!=operand2.uint64_count()) {
      result = operand2;
      seal_old::util::and_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
    } else {
      seal_old::util::and_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
    }
    return result;
  }
  ...
  */
  inline BigUInt operator|(const BigUInt &operand2) const {
    ...
    if (uint64_count!=this->uint64_count()) {
      result = *this;
      seal_old::util::or_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
    } else if (uint64_count!=operand2.uint64_count()) {
      result = operand2;
      seal_old::util::or_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
    } else {
      seal_old::util::or_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
    }
    return result;
  }
  ...
  */
  inline int compareto(const BigUInt &compare) const {
    int uint64_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
    int compare_uint64_count = seal_old::util::divide_round_up(compare.bit_count_, seal_old::util::bits_per_uint64);
    return seal_old::util::compare_uint_uint(value_.get(), uint64_count, compare.value_.get(), compare_uint64_count);
  }
  ...
  */
  inline bool operator==(const BigUInt &compare) const {
    int uint64_count = seal_old::util::divide_round_up(bit_count_, seal_old::util::bits_per_uint64);
    int compare_uint64_count = seal_old::util::divide_round_up(compare.bit_count_, seal_old::util::bits_per_uint64);
    return seal_old::util::compare_uint_uint(value_.get(), uint64_count, compare.value_.get(), compare_uint64_count)==0;
  }
  ...
  */
  inline BigUInt operator<<(int shift) const {
    ...
    BigUInt result(result_bits);
    result = *this;
    seal_old::util::left_shift_uint(result.pointer(), shift, result.uint64_count(), result.pointer());
    return result;
  }
  ...
  */
  inline BigUInt operator>>(int shift) const {
    ...
    BigUInt result(result_bits);
    result = *this;
    seal_old::util::right_shift_uint(result.pointer(), shift, result.uint64_count(), result.pointer());
    return result;
  }
  ...
  */
  inline BigUInt &operator-=(const BigUInt &operand2) {
    ...
    seal_old::util::sub_uint_uint(value_.get(),
                                  ...
                                  uint64_count(),
                                  value_.get());
    seal_old::util::filter_highbits_uint(value_.get(), uint64_count(), result_bits);
    return *this;
  }
  ...
  */
  inline BigUInt &operator^=(const BigUInt &operand2) {
    ...
    seal_old::util::xor_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
    return *this;
  }
  ...
  */
  inline BigUInt &operator&=(const BigUInt &operand2) {
    ...
    seal_old::util::and_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
    return *this;
  }
  ...
  */
  inline BigUInt &operator|=(const BigUInt &operand2) {
    ...
    seal_old::util::or_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
    return *this;
  }
  ...
  */
  inline BigUInt &operator<<=(int shift) {
    ...
    seal_old::util::left_shift_uint(value_.get(), shift, uint64_count(), value_.get());
    return *this;
  }
  ...
  */
  inline BigUInt &operator>>=(int shift) {
    ...
    seal_old::util::right_shift_uint(value_.get(), shift, uint64_count(), value_.get());
    return *this;
  }
  ...
  */
  inline BigUInt modinv(const BigUInt &modulus) const {
    ...
    BigUInt result(result_bits);
    result = *this;
    if (!seal::util::try_invert_uint_mod(result.pointer(),
                                         modulus.pointer(),
                                         result.uint64_count(),
                                         result.pointer(),
                                         pool_)) {
  ...
  */
  inline bool trymodinv(const BigUInt &modulus, BigUInt &inverse) const {
    ...
    inverse = *this;
    return seal::util::try_invert_uint_mod(inverse.pointer(),
                                           modulus.pointer(),
                                           inverse.uint64_count(),
                                           inverse.pointer(),
                                           pool_);
  }
 ...
 private:
  seal_old::util::MemoryPool pool_;
