    ...
    public:
        ...
        */
        inline std::uint8_t operator[](int index) const
        {
            ...
            return *seal_util::get_uint64_byte(value_.get(), index);
        }
        ...
        */
        inline void alias(int bit_count, std::uint64_t *value)
        {
            ...
            // Update class.
            value_ = seal_util::Pointer::Aliasing(value);
        ...
        */
        inline BigUInt operator +(const BigUInt &operand2) const
        {
            ...
            seal_util::add_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), false, result.uint64_count(), result.pointer());
            return result;
        }
        ...
        */
        inline BigUInt operator *(const BigUInt &operand2) const
        {
            ...
            BigUInt result(result_bits);
            seal_util::multiply_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), result.uint64_count(), result.pointer());
            return result;
        }
        ...
        */
        inline BigUInt operator ^(const BigUInt &operand2) const
        {
            ...
            {
                result = *this;
              seal_util::xor_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
            }
            else if (uint64_count != operand2.uint64_count())
            {
                result = operand2;
              seal_util::xor_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
            }
            else
            {
              seal_util::xor_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
            }
            return result;
        }
        ...
        */
        inline BigUInt operator &(const BigUInt &operand2) const
        {
            ...
            {
                result = *this;
              seal_util::and_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
            }
            else if (uint64_count != operand2.uint64_count())
            {
                result = operand2;
              seal_util::and_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
            }
            else
            {
              seal_util::and_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
            }
            return result;
        }
        ...
        */
        inline BigUInt operator |(const BigUInt &operand2) const 
        {
            ...
            {
                result = *this;
              seal_util::or_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
            }
            else if (uint64_count != operand2.uint64_count())
            {
                result = operand2;
              seal_util::or_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
            }
            else
            {
              seal_util::or_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
            }
            return result;
        }
        ...
        */
        inline BigUInt &operator +=(const BigUInt &operand2)
        {
          ...
          seal_util::add_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), false, uint64_count(), value_.get());
            return *this;
        }
        ...
        */
        inline BigUInt &operator ^=(const BigUInt &operand2)
        {
            ...
            seal_util::xor_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
            return *this;
        }
        ...
        */
        inline BigUInt &operator &=(const BigUInt &operand2)
        {
            ...
            seal_util::and_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
            return *this;
        }
        ...
        */
        inline BigUInt &operator |=(const BigUInt &operand2)
        {
            ...
            seal_util::or_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
            return *this;
        }
