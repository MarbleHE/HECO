...
#pragma managed(pop)
        ...
        inline void left_shift_uint(const std::uint64_t *operand, int shift_amount, int uint64_count, std::uint64_t *result)
        {
            ...
            int neg_bit_shift_amount = (seal::util::bits_per_uint64 - bit_shift_amount) & (static_cast<std::uint64_t>(bit_shift_amount == 0) - 1);
        ...
        inline void right_shift_uint(const std::uint64_t *operand, int shift_amount, int uint64_count, std::uint64_t *result)
        {
            ...
            int uint64_shift_amount = shift_amount / seal::util::bits_per_uint64;
            int bit_shift_amount = shift_amount - uint64_shift_amount * seal::util::bits_per_uint64;
            int neg_bit_shift_amount = (seal::util::bits_per_uint64 - bit_shift_amount) & (static_cast<int32_t>(bit_shift_amount == 0) - 1);
