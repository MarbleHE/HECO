...
namespace seal_old
{
    ...
    */
    ...
    public:
        ...
        to the plaintext modulus (represented by SmallModulus). Optionally, the user can 
        ...
        */
        BinaryEncoder(const SmallModulus &plain_modulus, const MemoryPoolHandle &pool = MemoryPoolHandle::Global());
    ...
    */
    ...
    public:
        ...
        @see MemoryPoolHandle for more details on memory pool handles.
        */
        BinaryFractionalEncoder(const SmallModulus &plain_modulus, const BigPoly &poly_modulus, int integer_coeff_count, 
            int fraction_coeff_count, const MemoryPoolHandle &pool = MemoryPoolHandle::Global());
    ...
    */
    ...
    public:
        ...
        @see MemoryPoolHandle for more details on memory pool handles.
        */
        BalancedFractionalEncoder(const SmallModulus &plain_modulus, const BigPoly &poly_modulus, int integer_coeff_count, 
            int fraction_coeff_count, std::uint64_t base = 3, const MemoryPoolHandle &pool = MemoryPoolHandle::Global());
    ...
    */
    ...
    public:
        ...
        @see MemoryPoolHandle for more details on memory pool handles.
        */
        FractionalEncoder(const SmallModulus &plain_modulus, const BigPoly &poly_modulus, int integer_coeff_count, int fraction_coeff_count, 
            std::uint64_t base = 2, const MemoryPoolHandle &pool = MemoryPoolHandle::Global());
