#include "ast_opt/utilities/seal_2.3.0/util/globals.h"
...
namespace seal_old
{
    namespace util
    {
        namespace global_variables
        {
            ...
            const double default_noise_standard_deviation = 3.19;
            ...
            */
            const map<int, vector<SmallModulus> > default_coeff_modulus_128
            {
                /*
                ...
                */
                ...
                Modulus count: 4
                Total bit count: 219 = 3 * 55 + 54
                */
                { 8192,{
                    0x7fffffffba0001, 0x7fffffffaa0001,
                    0x7fffffff7e0001, 0x3fffffffd60001
                } },

                /*
                Polynomial modulus: 1x^16384 + 1
                Modulus count: 8
                Total bit count: 441 = 56 + 7 * 55
                */
                { 16384,{
                    0xfffffffff00001, 0x7fffffffba0001,
                    0x7fffffffaa0001, 0x7fffffff7e0001,
                    0x7fffffff380001, 0x7ffffffef00001,
                    0x7ffffffeba0001, 0x7ffffffeac0001
                } },

                /*
                Polynomial modulus: 1x^32768 + 1
                Modulus count: 15
                Total bit count: 885 = 15 * 59
                */
                { 32768,{
                    0x7ffffffffcc0001, 0x7ffffffffba0001, 0x7ffffffffb00001,
                    0x7ffffffff320001, 0x7ffffffff2c0001, 0x7ffffffff240001,
                    0x7fffffffefa0001, 0x7fffffffede0001, 0x7fffffffe900001,
                    0x7fffffffe3c0001, 0x7fffffffe240001, 0x7fffffffddc0001,
                    0x7fffffffdbe0001, 0x7fffffffd740001, 0x7fffffffd640001
                } }
            };
            ...
            it easy for non-expert users to select secure parameters.
            */
            const map<int, vector<SmallModulus> > default_coeff_modulus_192
            {
                /*
                Polynomial modulus: 1x^1024 + 1
                Modulus count: 1
                ...
                */
                ...
                Polynomial modulus: 1x^4096 + 1
                Modulus count: 2
                Total bit count: 77 = 39 + 38
                */
                { 4096,{
                    0x7fffe40001, 0x3fffe80001
                } },

                /*
                Polynomial modulus: 1x^8192 + 1
                Modulus count: 3
                Total bit count: 153 = 3 * 51
                */
                { 8192,{
                    0x7ffffff9c0001, 0x7ffffff900001, 0x7ffffff240001
                } },
            ...
            */
            ...
            // User-defined moduli
            const vector<SmallModulus> small_mods_custom{
            };
            ...
            namespace internal_mods
            {
                ...
                // 33 bits
                const SmallModulus m_tilde(1ULL << 32);
