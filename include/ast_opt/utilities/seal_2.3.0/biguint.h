...
#include "ast_opt/utilities/seal_2.3.0/util/common.h"
#include "ast_opt/utilities/seal_2.3.0/util/uintcore.h"
#include "ast_opt/utilities/seal_2.3.0/util/uintarith.h"
#include "ast_opt/utilities/seal_2.3.0/util/uintarithmod.h"
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            return util::divide_round_up(bit_count_, util::bits_per_byte);
        }
        ...
        */
        ...
        {
            return util::divide_round_up(bit_count_, util::bits_per_uint64);
        }
        ...
        */
        inline int significant_bit_count() const
        {
            ...
            int uint64_count = util::divide_round_up(bit_count_, util::bits_per_uint64);
        ...
        */
        ...
        {
            int byte_count = util::divide_round_up(bit_count_, util::bits_per_byte);
        ...
        */
        inline BigUInt operator -() const
        {
            ...
            util::negate_uint(value_.get(), result.uint64_count(), result.pointer());
            util::filter_highbits_uint(result.pointer(), result.uint64_count(), result.bit_count());
            return result;
        }
        ...
        */
        ...
        {
            BigUInt result(bit_count_);
            util::not_uint(value_.get(), result.uint64_count(), result.pointer());
            util::filter_highbits_uint(result.pointer(), result.uint64_count(), result.bit_count());
            return result;
        }
        ...
        */
        inline BigUInt &operator ++()
        {
            if (util::increment_uint(value_.get(), uint64_count(), value_.get()))
            {
                ...
                resize(bit_count_ + 1);
                util::set_bit_uint(value_.get(), uint64_count(), carry_bit);
            }
        ...
        */
        inline BigUInt operator +(const BigUInt &operand2) const
        {
            ...
            util::add_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), false, result.uint64_count(), result.pointer());
            return result;
        }
        ...
        */
        inline BigUInt operator -(const BigUInt &operand2) const
        {
            ...
            BigUInt result(result_bits);
            util::sub_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), false, result.uint64_count(), result.pointer());
            util::filter_highbits_uint(result.pointer(), result.uint64_count(), result_bits);
            return result;
        }
        ...
        */
        inline BigUInt operator *(const BigUInt &operand2) const
        {
            ...
            BigUInt result(result_bits);
            util::multiply_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), result.uint64_count(), result.pointer());
            return result;
        }
        ...
        */
        inline BigUInt operator %(const BigUInt &operand2) const
        {
            ...
            util::Modulus modulus(operand2.pointer(), operand2.uint64_count(), pool_);
            int result_bits = significant_bit_count();
            BigUInt result(result_bits);
            result = *this;
            int uint64_count = util::divide_round_up(result_bits, util::bits_per_uint64);
            util::modulo_uint_inplace(result.pointer(), uint64_count, modulus, pool_);
            return result;
        }
        ...
        */
        inline BigUInt operator ^(const BigUInt &operand2) const
        {
            ...
            {
                result = *this;
                util::xor_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
            }
            else if (uint64_count != operand2.uint64_count())
            {
                result = operand2;
                util::xor_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
            }
            else
            {
                util::xor_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
            }
            return result;
        }
        ...
        */
        inline BigUInt operator &(const BigUInt &operand2) const
        {
            ...
            {
                result = *this;
                util::and_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
            }
            else if (uint64_count != operand2.uint64_count())
            {
                result = operand2;
                util::and_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
            }
            else
            {
                util::and_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
            }
            return result;
        }
        ...
        */
        inline BigUInt operator |(const BigUInt &operand2) const 
        {
            ...
            {
                result = *this;
                util::or_uint_uint(result.pointer(), operand2.pointer(), uint64_count, result.pointer());
            }
            else if (uint64_count != operand2.uint64_count())
            {
                result = operand2;
                util::or_uint_uint(result.pointer(), value_.get(), uint64_count, result.pointer());
            }
            else
            {
                util::or_uint_uint(value_.get(), operand2.pointer(), uint64_count, result.pointer());
            }
            return result;
        }
        ...
        */
        ...
        {
            int uint64_count = util::divide_round_up(bit_count_, util::bits_per_uint64);
            int compare_uint64_count = util::divide_round_up(compare.bit_count_, util::bits_per_uint64);
            return util::compare_uint_uint(value_.get(), uint64_count, compare.value_.get(), compare_uint64_count);
        }
        ...
        */
        inline bool operator <(const BigUInt &compare) const
        {
            int uint64_count = util::divide_round_up(bit_count_, util::bits_per_uint64);
            int compare_uint64_count = util::divide_round_up(compare.bit_count_, util::bits_per_uint64);
            return util::compare_uint_uint(value_.get(), uint64_count, compare.value_.get(), compare_uint64_count) < 0;
        }
        ...
        */
        inline BigUInt operator <<(int shift) const
        {
            ...
            BigUInt result(result_bits);
            result = *this;
            util::left_shift_uint(result.pointer(), shift, result.uint64_count(), result.pointer());
            return result;
        }
        ...
        */
        inline BigUInt operator >>(int shift) const
        {
            ...
            BigUInt result(result_bits);
            result = *this;
            util::right_shift_uint(result.pointer(), shift, result.uint64_count(), result.pointer());
            return result;
        }
        ...
        */
        inline BigUInt &operator +=(const BigUInt &operand2)
        {
            ...
            util::add_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), false, uint64_count(), value_.get());
            return *this;
        }
        ...
        */
        inline BigUInt &operator -=(const BigUInt &operand2)
        {
            ...
            util::sub_uint_uint(value_.get(), uint64_count(), operand2.pointer(), operand2.uint64_count(), false, uint64_count(), value_.get());
        ...
        */
        inline BigUInt &operator ^=(const BigUInt &operand2)
        {
            ...
            util::xor_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
            return *this;
        }
        ...
        */
        inline BigUInt &operator &=(const BigUInt &operand2)
        {
            ...
            util::and_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
            return *this;
        }
        ...
        */
        inline BigUInt &operator |=(const BigUInt &operand2)
        {
            ...
            util::or_uint_uint(value_.get(), operand2.pointer(), operand2.uint64_count(), value_.get());
            return *this;
        }
