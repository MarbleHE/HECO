...
#include "ast_opt/utilities/seal_2.3.0/util/uintarithsmallmod.h"
#include "ast_opt/utilities/seal_2.3.0/util/polycore.h"
#include "ast_opt/utilities/seal_2.3.0/util/polyarithmod.h"
#include "ast_opt/utilities/seal_2.3.0/util/polyarithsmallmod.h"
#include "ast_opt/utilities/seal_2.3.0/util/polyfftmultsmallmod.h"

using namespace std;
using namespace seal_old::util;
