#ifndef AST_OPTIMIZER_INCLUDE_AST_OPT_UTILITIES_NODERELATIONSHIP_H_
#define AST_OPTIMIZER_INCLUDE_AST_OPT_UTILITIES_NODERELATIONSHIP_H_
...
#endif //AST_OPTIMIZER_INCLUDE_AST_OPT_UTILITIES_NODERELATIONSHIP_H_
