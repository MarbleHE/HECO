#ifndef AST_OPTIMIZER_INCLUDE_AST_OPT_AST_LITERALBOOL_H_
#define AST_OPTIMIZER_INCLUDE_AST_OPT_AST_LITERALBOOL_H_
...
#endif //AST_OPTIMIZER_INCLUDE_AST_OPT_AST_LITERALBOOL_H_
