module {
  func.func private @encryptedRobertsCross_4x4(%arg0: !emitc.opaque<"seal::Ciphertext">) -> !emitc.opaque<"seal::Ciphertext"> {
    ...
    %2 = emitc.call "evaluator_rotate"(%arg0) {args = [0 : index, 13 : si32]} : (!emitc.opaque<"seal::Ciphertext">) -> !emitc.opaque<"seal::Ciphertext">
    ...
    %7 = emitc.call "evaluator_rotate"(%5) {args = [0 : index, 4 : si32]} : (!emitc.opaque<"seal::Ciphertext">) -> !emitc.opaque<"seal::Ciphertext">
