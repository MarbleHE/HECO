module {
  func.func private @encryptedMVP(%arg0: tensor<16xf64>, %arg1: tensor<4x!fhe.secret<f64>>) -> tensor<4x!fhe.secret<f64>> {
    ...
    %7 = tensor.extract %arg1[%c2] : tensor<4x!fhe.secret<f64>>
    %8 = fhe.multiply(%6, %7) : (f64, !fhe.secret<f64>) -> !fhe.secret<f64>
    %9 = tensor.extract %arg0[%c3] : tensor<16xf64>
    %10 = tensor.extract %arg1[%c3] : tensor<4x!fhe.secret<f64>>
    ...
    %13 = tensor.insert %12 into %arg1[%c0] : tensor<4x!fhe.secret<f64>>
    ...
    %23 = tensor.insert %22 into %13[%c1] : tensor<4x!fhe.secret<f64>>
    ...
    %33 = tensor.insert %32 into %23[%c2] : tensor<4x!fhe.secret<f64>>
    ...
    %43 = tensor.insert %42 into %33[%c3] : tensor<4x!fhe.secret<f64>>
    return %43 : tensor<4x!fhe.secret<f64>>
  }
}
