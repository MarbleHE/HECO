...
module {
  func.func private @encryptedPoly(%arg0: !eva.cipher<4 x fixed_point>, %arg1: !eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point> {
    ...
    %2 = eva.rescale(%1) : (!eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
    %3 = eva.multiply(%arg1, %arg1) : (!eva.cipher<4 x fixed_point>, !eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
    %4 = eva.multiply(%2, %3) : (!eva.cipher<4 x fixed_point>, !eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
    %5 = eva.rescale(%4) : (!eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
...
// CHECK:     %7 = eva.multiply(%4, %6) : (!eva.cipher<4 x fixed_point>, !eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
// CHECK:     %8 = eva.relinearize(%7) : (!eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
// CHECK:     %9 = eva.rescale(%8) : (!eva.cipher<4 x fixed_point>) -> !eva.cipher<4 x fixed_point>
// CHECK:     return %9 : !eva.cipher<4 x fixed_point>
// CHECK:   }
// CHECK: }
