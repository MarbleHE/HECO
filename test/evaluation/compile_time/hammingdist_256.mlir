...
module  {
  func.func private @encryptedHammingDistance(%arg0: tensor<256x!fhe.secret<i16>>, %arg1: tensor<256x!fhe.secret<i16>>) -> !fhe.secret<i16> {
...
===-------------------------------------------------------------------------===
  Total Execution Time: 0.0221 seconds

  ----Wall Time----  ----Name----
    0.0221 (100.0%)  root
    0.0156 ( 70.4%)  Canonicalizer
    0.0014 (  6.3%)  NaryPass
    0.0014 (  6.1%)  CSE
    0.0010 (  4.4%)  BatchingPass
    0.0008 (  3.6%)  UnrollLoopsPass
    0.0007 (  3.2%)  Tensor2BatchedSecretPass
    0.0006 (  2.5%)  Output
    0.0002 (  1.1%)  Parser
    0.0001 (  0.3%)  InternalOperandBatchingPass
