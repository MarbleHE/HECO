...
#include <include/heco/legacy_ast/ast_parser/Errors.h>
#include <typeinfo>
...
{ /* NOLINT */
    ...
    auto bp = new BinaryExpression(
        std::make_unique<LiteralInt>(5), Operator(ArithmeticOp::ADDITION), std::make_unique<LiteralInt>(6));
...
{ /* NOLINT */
    ...
    auto ifStatement = std::make_unique<If>(
        std::move(std::make_unique<BinaryExpression>(
            std::move(std::make_unique<Variable>("a")), Operator(GREATER), std::move(std::make_unique<LiteralInt>(5)))),
        std::move(
            std::make_unique<Block>(std::move(std::make_unique<Return>(std::move(std::make_unique<LiteralInt>(1)))))));
...
{ /* NOLINT */
    ...
    auto ifStatement = std::make_unique<If>(
        std::move(std::make_unique<BinaryExpression>(
            std::move(std::make_unique<Variable>("a")), Operator(GREATER), std::move(std::make_unique<LiteralInt>(5)))),
        std::move(
            std::make_unique<Block>(std::move(std::make_unique<Return>(std::move(std::make_unique<LiteralInt>(111)))))),
        std::move(
            std::make_unique<Block>(std::move(std::make_unique<Return>(std::move(std::make_unique<LiteralInt>(0)))))));
...
{ /* NOLINT */
    ...
    auto ifStatement4256 = std::make_unique<If>(
        std::move(std::make_unique<BinaryExpression>(
            std::move(std::make_unique<Variable>("a")), Operator(GREATER),
    ...
    auto ifStatementEqual0 = std::make_unique<If>(
        std::move(std::make_unique<BinaryExpression>(
            std::move(std::make_unique<Variable>("a")), Operator(EQUAL), std::move(std::make_unique<LiteralInt>(0)))),
        std::move(std::make_unique<Block>(
    ...
    auto ifStatementLess0 = std::make_unique<If>(
        std::move(std::make_unique<BinaryExpression>(
            std::move(std::make_unique<Variable>("a")), Operator(LESS), std::move(std::make_unique<LiteralInt>(0)))),
        std::move(
            std::make_unique<Block>(std::move(std::make_unique<Return>(std::move(std::make_unique<LiteralInt>(-1)))))),
...
{ /* NOLINT */
    ...
    // int sum = 0;
    auto declarationSum = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, false), std::make_unique<Variable>("sum"), std::make_unique<LiteralInt>(0));
    ...
    functionParameters.emplace_back(std::make_unique<FunctionParameter>(Datatype(Type::INT, false), "bound"));

    auto expected = new Function(
        Datatype(Type::INT, true), "computeSum", std::move(functionParameters),
...
{ /* NOLINT */
    ...
    auto expected = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, false), std::make_unique<Variable>("i"), std::make_unique<LiteralInt>(0));
...
{ /* NOLINT */
    ...
    // int scalar = {2};
    auto declarationScalar = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, false), std::move(std::make_unique<Variable>("scalar")),
    ...
    auto declarationVec = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, false), std::make_unique<Variable>("vec"),
    ...
    auto expected = std::make_unique<Function>(
        Datatype(Type::VOID), "main", std::move(std::vector<std::unique_ptr<FunctionParameter>>()),
...
{ /* NOLINT */
    ...
    auto declarationVec = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, false), std::make_unique<Variable>("vec"), std::move(exprsList));
...
{ /* NOLINT */
    ...
    auto assignVec = std::make_unique<Assignment>(
        std::make_unique<IndexAccess>(std::make_unique<Variable>("vec"), std::make_unique<LiteralInt>(3)),
        std::make_unique<LiteralInt>(0));
...
{ /* NOLINT */
    ...
    auto expr = std::make_unique<BinaryExpression>(
        std::make_unique<Variable>("__input2__"), Operator(ArithmeticOp::FHE_ADDITION),
...
{ /* NOLINT */
    ...
    auto expr = std::make_unique<BinaryExpression>(
        std::make_unique<BinaryExpression>(
            std::make_unique<LiteralInt>(5), Operator(ADDITION), std::make_unique<LiteralInt>(7)),
        Operator(MULTIPLICATION),
        std::make_unique<BinaryExpression>(
            std::make_unique<Variable>("b"), Operator(LESS), std::make_unique<LiteralInt>(10)));

    blockStatements.push_back(
        std::make_unique<VariableDeclaration>(Datatype(Type::INT), std::make_unique<Variable>("a"), std::move(expr)));
...
{ /* NOLINT */
    ...
    auto varDecl = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, true), std::make_unique<Variable>("b"), std::make_unique<LiteralInt>(11));
...
{ /* NOLINT */
    ...
    auto varDecl = std::make_unique<VariableDeclaration>(
        Datatype(Type::INT, true), std::make_unique<Variable>("b"), std::make_unique<ExpressionList>(std::move(exprs)));
