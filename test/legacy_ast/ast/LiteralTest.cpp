...
{ /* NOLINT */
    ...
    nlohmann::json j = { { "type", "LiteralInt" }, { "value", val } };
...
{ /* NOLINT */
    ...
    nlohmann::json j = { { "type", "LiteralFloat" }, { "value", val } };
    EXPECT_EQ(lint->toJson(), j);
}
...
{ /* NOLINT */
    ...
    nlohmann::json j = { { "type", "LiteralBool" }, { "value", val } };
...
{ /* NOLINT */
    ...
    nlohmann::json j = { { "type", "LiteralString" }, { "value", val } };
