...
TEST(TernaryOperatorTest, values_ValuesGivenInCtorAreRetrievable)
{
    ...
    TernaryOperator ternaryOperator(
        std::make_unique<LiteralBool>(true), std::make_unique<Variable>("foo"), std::make_unique<Variable>("boo"));
...
TEST(TernaryOperatorTest, DISABLED_CopyAssignmentCopiesValue)
{
    ...
    //
    //  TernaryOperator copiedTernaryOperatorf(std::make_unique<LiteralBool>(false), std::make_unique<Block>(),
...
TEST(TernaryOperatorTest, DISABLED_JsonOutputTest)
{ /* NOLINT */
    //  VariableDeclaration variableDeclaration1(Datatype(Type::BOOL), std::make_unique<Variable>("foo"));
    //  VariableDeclaration variableDeclaration2(Datatype(Type::BOOL), std::make_unique<Variable>("boo"));
    //  TernaryOperator iff(std::make_unique<LiteralBool>(true),
