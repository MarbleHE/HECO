...
//CHECK:     %2 = eva.rotate(%1) by 2 : <4 x fixed_point : 80 : -1>
//CHECK:     %3 = eva.add(%1, %2) : (!eva.cipher<4 x fixed_point : 80 : -1>, !eva.cipher<4 x fixed_point : 80 : -1>) -> !eva.cipher<4 x fixed_point : 80 : -1>
//CHECK:     %4 = eva.rotate(%3) by 3 : <4 x fixed_point : 80 : -1>
//CHECK:     %5 = eva.add(%3, %4) : (!eva.cipher<4 x fixed_point : 80 : -1>, !eva.cipher<4 x fixed_point : 80 : -1>) -> !eva.cipher<4 x fixed_point : 80 : -1>
//CHECK:     return %5 : !eva.cipher<4 x fixed_point : 80 : -1>
//CHECK:   }
//CHECK: }
