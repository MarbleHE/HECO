...
//CHECK:     %0 = eva.multiply(%arg0, %arg0) : (!eva.cipher<4 x fixed_point : -1 : -1>, !eva.cipher<4 x fixed_point : -1 : -1>) -> !eva.cipher<4 x fixed_point : 60 : -1>
//CHECK:     %1 = eva.add(%0, %arg0) : (!eva.cipher<4 x fixed_point : 60 : -1>, !eva.cipher<4 x fixed_point : 30 : -1>) -> !eva.cipher<4 x fixed_point : 60 : -1>
//CHECK:     %2 = eva.add(%1, %arg0) : (!eva.cipher<4 x fixed_point : 60 : -1>, !eva.cipher<4 x fixed_point : 30 : -1>) -> !eva.cipher<4 x fixed_point : 60 : -1>
//CHECK:     return %2 : !eva.cipher<4 x fixed_point : 60 : -1>
//CHECK:   }
//CHECK: }
