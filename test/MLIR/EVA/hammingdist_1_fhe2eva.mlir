...
// CHECK: module  {
// CHECK:   func private @encryptedHammingDistance(%arg0: !eva.cipher<4 x f64>, %arg1: !eva.cipher<4 x f64>) -> !eva.cipher<4 x f64> {
// CHECK:     %0 = eva.sub(%arg0, %arg1) : (!eva.cipher<4 x f64>, !eva.cipher<4 x f64>) -> !eva.cipher<4 x f64>
// CHECK:     %1 = eva.multiply(%0, %0) : (!eva.cipher<4 x f64>, !eva.cipher<4 x f64>) -> !eva.cipher<4 x f64>
// CHECK:     %2 = eva.rotate(%1) by -2 : <4 x f64>
// CHECK:     %3 = eva.add(%1, %2) : (!eva.cipher<4 x f64>, !eva.cipher<4 x f64>) -> !eva.cipher<4 x f64>
// CHECK:     %4 = eva.rotate(%3) by -1 : <4 x f64>
// CHECK:     %5 = eva.add(%3, %4) : (!eva.cipher<4 x f64>, !eva.cipher<4 x f64>) -> !eva.cipher<4 x f64>
// CHECK:     return %5 : !eva.cipher<4 x f64>
// CHECK:   }
// CHECK: }