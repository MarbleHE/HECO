...
static std::map<int, std::function<void(AbstractNode &)> > call = {  /* NOLINT */
...
void AstTestingGenerator::generateAst(int id, AbstractNode &ast) {
...
//void AstTestingGenerator::genLaplacianInnerLoopsOnlyAstWithCustomWeights(AbstractNode &ast, Matrix<int> *weights) {
  // -- source code --
