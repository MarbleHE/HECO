...
{
    // TODO: This test simply checks that return type, identifier, parameter vector and body can be set and get
    // correctly.
}

TEST(FunctionTest, CopyCtorCopiesValue)
{
    // TODO: When copying a Function, the new object should contain a (deep) copy of the return type, identifier,
    // parameter vector and body
}

TEST(FunctionTest, CopyAssignmentCopiesValue)
{
    // TODO: When copying a Function, the new object should contain a copy of the return type, identifier, parameter
    // vector and body
}

TEST(FunctionTest, MoveCtorPreservesValue)
{
    // TODO: When moving a Function, the new object should contain the same return type, identifier, parameter vector
    // and body
}
