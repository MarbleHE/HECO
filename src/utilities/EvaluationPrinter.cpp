...
EvaluationPrinter &EvaluationPrinter::setEvaluationParameters(std::unordered_map<std::string, AbstractLiteral *> *evalParams) {
...
void EvaluationPrinter::printEvaluationResults(const std::vector<AbstractLiteral *> &resultExpected,
