...
struct operator_info {
  ...
  operator_info(node_operation operation, size_t line_number, size_t char_index) :
    ...
    switch (operation) {
      case node_operation::init: precedence = operator_precedence::brackets;
        break;
      ...
      case node_operation::call: precedence = operator_precedence::postfix;
        break;
      ...
      case node_operation::tostring: precedence = operator_precedence::prefix;
        break;
      case node_operation::mul:
      case node_operation::div:
      case node_operation::idiv:
      case node_operation::mod: precedence = operator_precedence::multiplication;
        break;
      case node_operation::add:
      case node_operation::sub:
      case node_operation::concat: precedence = operator_precedence::addition;
        break;
      case node_operation::bsl:
      case node_operation::bsr: precedence = operator_precedence::shift;
        break;
      case node_operation::lt:
      case node_operation::gt:
      case node_operation::le:
      case node_operation::ge: precedence = operator_precedence::comparison;
        break;
      case node_operation::eq:
      case node_operation::ne: precedence = operator_precedence::equality;
        break;
      case node_operation::band: precedence = operator_precedence::bitwise_and;
        break;
      case node_operation::bxor: precedence = operator_precedence::bitwise_xor;
        break;
      case node_operation::bor: precedence = operator_precedence::bitwise_or;
        break;
      case node_operation::land: precedence = operator_precedence::logical_and;
        break;
      case node_operation::lor: precedence = operator_precedence::logical_or;
        break;
      ...
      case node_operation::ternary: precedence = operator_precedence::assignment;
        break;
      case node_operation::comma: precedence = operator_precedence::comma;
        break;
    }

    switch (precedence) {
      case operator_precedence::prefix:
      case operator_precedence::assignment: associativity = operator_associativity::right_to_left;
        break;
      default: associativity = operator_associativity::left_to_right;
        break;
    }

    switch (operation) {
      case node_operation::init: number_of_operands = 0; //zero or more
        break;
      case node_operation::postinc:
      case node_operation::postdec:
      case node_operation::preinc:
      ...
      case node_operation::call: //at least one
        ...
        break;
      case node_operation::ternary: number_of_operands = 3;
        break;
      default: number_of_operands = 2;
        break;
    }
  }
};
...
operator_info get_operator_info(reserved_token token, bool prefix, size_t line_number, size_t char_index) {
  switch (token) {
    ...
    case reserved_token::concat: return operator_info(node_operation::concat, line_number, char_index);
    case reserved_token::mul: return operator_info(node_operation::mul, line_number, char_index);
    case reserved_token::div: return operator_info(node_operation::div, line_number, char_index);
    case reserved_token::idiv: return operator_info(node_operation::idiv, line_number, char_index);
    case reserved_token::mod: return operator_info(node_operation::mod, line_number, char_index);
    case reserved_token::bitwise_not: return operator_info(node_operation::bnot, line_number, char_index);
    case reserved_token::bitwise_and: return operator_info(node_operation::band, line_number, char_index);
    case reserved_token::bitwise_or: return operator_info(node_operation::bor, line_number, char_index);
    case reserved_token::bitwise_xor: return operator_info(node_operation::bxor, line_number, char_index);
    case reserved_token::shiftl: return operator_info(node_operation::bsl, line_number, char_index);
    case reserved_token::shiftr: return operator_info(node_operation::bsr, line_number, char_index);
    case reserved_token::assign: return operator_info(node_operation::assign, line_number, char_index);
    case reserved_token::add_assign: return operator_info(node_operation::add_assign, line_number, char_index);
    case reserved_token::sub_assign: return operator_info(node_operation::sub_assign, line_number, char_index);
    case reserved_token::concat_assign: return operator_info(node_operation::concat_assign, line_number, char_index);
    case reserved_token::mul_assign: return operator_info(node_operation::mod_assign, line_number, char_index);
    case reserved_token::div_assign: return operator_info(node_operation::div_assign, line_number, char_index);
    case reserved_token::idiv_assign: return operator_info(node_operation::idiv_assign, line_number, char_index);
    case reserved_token::mod_assign: return operator_info(node_operation::mod_assign, line_number, char_index);
    case reserved_token::and_assign: return operator_info(node_operation::band_assign, line_number, char_index);
    case reserved_token::or_assign: return operator_info(node_operation::bor_assign, line_number, char_index);
    case reserved_token::xor_assign: return operator_info(node_operation::bxor_assign, line_number, char_index);
    case reserved_token::shiftl_assign: return operator_info(node_operation::bsl_assign, line_number, char_index);
    case reserved_token::shiftr_assign: return operator_info(node_operation::bsr_assign, line_number, char_index);
    case reserved_token::logical_not: return operator_info(node_operation::lnot, line_number, char_index);
    case reserved_token::logical_and: return operator_info(node_operation::land, line_number, char_index);
    case reserved_token::logical_or: return operator_info(node_operation::lor, line_number, char_index);
    case reserved_token::eq: return operator_info(node_operation::eq, line_number, char_index);
    case reserved_token::ne: return operator_info(node_operation::ne, line_number, char_index);
    case reserved_token::lt: return operator_info(node_operation::lt, line_number, char_index);
    case reserved_token::gt: return operator_info(node_operation::gt, line_number, char_index);
    case reserved_token::le: return operator_info(node_operation::le, line_number, char_index);
    case reserved_token::ge: return operator_info(node_operation::ge, line_number, char_index);
    case reserved_token::question: return operator_info(node_operation::ternary, line_number, char_index);
    case reserved_token::comma: return operator_info(node_operation::comma, line_number, char_index);
    case reserved_token::open_round: return operator_info(node_operation::call, line_number, char_index);
    case reserved_token::open_square: return operator_info(node_operation::index, line_number, char_index);
    case reserved_token::kw_sizeof: return operator_info(node_operation::size, line_number, char_index);
    case reserved_token::kw_tostring: return operator_info(node_operation::tostring, line_number, char_index);
    case reserved_token::open_curly: return operator_info(node_operation::init, line_number, char_index);
    default: throw unexpected_syntax_error(std::to_string(token), line_number, char_index);
  }
}
...
bool is_end_of_expression(const token &t, bool allow_comma) {
  ...
  if (t.is_reserved_token()) {
    switch (t.get_reserved_token()) {
      ...
      case reserved_token::colon: return true;
      case reserved_token::comma: return !allow_comma;
...
bool is_evaluated_before(const operator_info &l, const operator_info &r) {
  return l.associativity==operator_associativity::left_to_right ? l.precedence <= r.precedence : l.precedence
      < r.precedence;
}
...
void pop_one_operator(
  ...
  operand_stack.push(std::make_unique<node>(
      ...
      std::move(operands),
      operator_stack.top().line_number,
      operator_stack.top().char_index)
  );

  operator_stack.pop();
}

node_ptr parse_expression_tree_impl(compiler_context &context,
                                    tokens_iterator &it,
                                    bool allow_comma,
                                    bool allow_empty) {
    ...
    if (it->is_reserved_token()) {
      ...
      switch (oi.operation) {
        case node_operation::call: ++it;
          ...
          break;
        case node_operation::index: ++it;
          operand_stack.push(parse_expression_tree_impl(context, it, true, false));
          if (!it->has_value(reserved_token::close_square)) {
            throw syntax_error("Expected closing ]'", it->get_line_number(), it->get_char_index());
          }
          break;
        case node_operation::ternary: ++it;
          operand_stack.push(parse_expression_tree_impl(context, it, true, false));
