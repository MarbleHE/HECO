...
node::node(compiler_context &context,
           node_value value,
  ...
  std::visit(overloaded{
      ...
      [&](node_operation value) {
        switch (value) {
          case node_operation::param: _type_id = _children[0]->_type_id;
            _lvalue = false;
            break;
          case node_operation::preinc:
          case node_operation::predec: _type_id = number_handle;
            _lvalue = true;
            _children[0]->check_conversion(number_handle, true);
            break;
          case node_operation::postinc:
          case node_operation::postdec: _type_id = number_handle;
            _lvalue = false;
            _children[0]->check_conversion(number_handle, true);
            break;
          ...
          case node_operation::lnot: _type_id = number_handle;
            _lvalue = false;
            _children[0]->check_conversion(number_handle, false);
            break;
          case node_operation::size: _type_id = number_handle;
            _lvalue = false;
            break;
          case node_operation::tostring: _type_id = string_handle;
            _lvalue = false;
            break;
          ...
          case node_operation::lor: _type_id = number_handle;
            _lvalue = false;
            _children[0]->check_conversion(number_handle, false);
          ...
          case node_operation::ge: _type_id = number_handle;
            _lvalue = false;
            ...
            break;
          case node_operation::concat: _type_id = context.get_handle(simple_type::string);
            _lvalue = false;
            _children[0]->check_conversion(string_handle, false);
            _children[1]->check_conversion(string_handle, false);
            break;
          case node_operation::assign: _type_id = _children[0]->get_type_id();
            _lvalue = true;
          ...
          case node_operation::bsr_assign: _type_id = number_handle;
            _lvalue = true;
            _children[0]->check_conversion(number_handle, true);
            _children[1]->check_conversion(number_handle, false);
            break;
          case node_operation::concat_assign: _type_id = string_handle;
            _lvalue = true;
          ...
          case node_operation::comma:
            ...
            break;
          case node_operation::index: _lvalue = _children[0]->is_lvalue();
            ...
            break;
          case node_operation::ternary: _children[0]->check_conversion(number_handle, false);
            if (is_convertible(
