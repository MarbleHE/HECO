...
{
  return *this == Operator(FHE_MULTIPLICATION) || *this == Operator(ArithmeticOp::MULTIPLICATION) || *this == Operator(ArithmeticOp::FHE_MULTIPLICATION) || *this == Operator(ArithmeticOp::ADDITION) || *this == Operator(ArithmeticOp::FHE_ADDITION) || *this == Operator(LogicalOp::EQUAL) || *this == Operator(LogicalOp::NOTEQUAL) || *this == Operator(LogicalOp::BITWISE_AND) || *this == Operator(LogicalOp::BITWISE_XOR) || *this == Operator(LogicalOp::BITWISE_OR) || *this == Operator(LogicalOp::LOGICAL_AND) || *this == Operator(LogicalOp::LOGICAL_OR);
}
